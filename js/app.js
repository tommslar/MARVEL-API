...
function submitAction(event){
  ...
  var url = "http://gateway.marvel.com/v1/public/characters?ts=3&apikey=c1680b1c23d63841f3fcc41a6be03b08&hash=89510c82b85091fd0158427d4c38244f";
  $.get(url, {name: valorBuscado}, function(response){
  	if (response.data.count == 0){
  		alert('No se encontró el superheroe con el nombre solicitado')
  	}
  	else{
  		appendHTML(response);
  	}
